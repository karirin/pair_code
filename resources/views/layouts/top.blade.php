...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-YN5QWRE5QW"></script>
    <script>
...
<body style="height: auto;">
    ...
    @section('header')
    @if (Auth::check())
    @if(request()->path()!='privacy_poricy' && request()->path()!='terms_of_service' && request()->path()!='user/edit_detail' && request()->path()!='auth/twitter/callback' && request()->path()!='user/edit_detail_google' && request()->path()!='login/callback' && request()->path()!='user/edit_detail_twitter' && request()->path()!='callback'&& request()->path()!='user/edit_detail_line')
