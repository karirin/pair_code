...
<body>
    ...
    <div class="row">
        <div class="col-2.5">
            <ul>
                ...
                <li class="header_menu_wide" style="margin-top: 4rem;"><a href="{{ asset('top') }}"
                ...
                <li class="header_menu_wide"><a href="{{ asset('match/match') }}" style="vertical-align: middle;"><i
                            class="fas fa-thumbs-up" style="margin-right: 2rem;font-size: 1.5rem;"></i><span
                            class="new_match_mark" style="display: none;"></span>お相手から</a>
                </li>
                <li class="header_menu"><a href="{{ asset('message/message_top') }}" style="vertical-align: middle;">
                        @if($message_count==''&&$message_count!=0||$message_count=='match')<i
                            class="fas fa-comment"></i><span class="new_mark"></span>@else<i class="fas fa-comment"
                            style="margin-right: 2rem;font-size: 1.5rem;"></i>@endifメッセージ
                    </a></li>
    ...
    @if(request()->path()=='match/match'||request()->path()=='message/message_top'||request()->path()=='message/message'||request()->path()=='message/add'||request()->path()=='top'||!Auth::check())
