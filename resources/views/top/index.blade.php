...
<div class="maintop_page" style="display: none;">
    <image src="storage/top/haikei.png" class="haikei" style="height: auto;">
        <div class="row PC">
            <div class="col-6">
                <image src="storage/top/remote-team.png" class="top_image" style="width:96%;height: auto;margin-left: 3rem;">
            </div>
            <div class="col-6">
                <image src="../storage/top/top logo.png" class="top_logo">
                    <div style="padding-left: 12rem;padding-top: 2rem;">
                        <a href="{{ asset('user/add') }}" class="user_login_btn btn btn-secondary" style="vertical-align: middle;">新規登録</a>
                        <div><a href="{{ asset('user/login') }}" class="user_add_btn btn btn-outline-dark" style="vertical-align: middle;">ログイン</a>
                        </div>
                    </div>
            </div>
        </div>
        <div class="row mobile" style="text-align: center;padding-top: 5rem;">
            <div>
                <image src="../storage/top/top logo.png" class="top_logo">
            </div>
            <div class="col-6">
