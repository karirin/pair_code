        ...
        <div class="form" style="width: 100%;">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div id="myprofile_skill" style="width: 60%;">@foreach($skills as $skill)@if($skill!='')@if(3 <= $i)<span id="child-span_myprofile" class="skill_tag extra" style="display: none;">
