...
$(document).on('click', '.profile_edit_btn', function() {
    ...
    $('.workhistory').replaceWith('<textarea class="edit_workhistory form-control" type="text" style="width: 60%;height: 40%;" name="user_workhistory" value="' + user_workhistory + '">' + user_workhistory);
...
$(document).on('click', ".match_good_btn", function() {
    ...
    $.ajax({
        ...
        console.log($('.match_user_btn')[0]);
        $('.match_user_btn')[0].val = user_id;
    }).fail(function() {});
});
