...
class GoogleLoginController extends Controller
{
    ...
    public function authGoogleCallback()
    {
        ...
        $param = ['current_user' => $user, 'profile' => $user->profile, 'name' => $googleUser->name, 'password' => '', 'hash_password' => '', 'image' => $user->image, 'users' => $users, 'skills' => $skills, 'licences' => $licences, 'message_count' => $message_count, 'message' => $message, 'top_message' => '', 'match_flg' => $match_flg, 'email' => $email, 'google_id' => $googleUser->id];
        return view('user.edit_detail_google', $param);
    }
}
