...
class LineLoginController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        if ($user) {
            ...
            $param = ['current_user' => $user, 'profile' => $user->profile, 'name' => $user->name, 'password' => '', 'hash_password' => '', 'image' => $user->image, 'users' => $users, 'skills' => $skills, 'licences' => $licences, 'message_count' => $message_count, 'message' => $message, 'top_message' => '', 'match_flg' => $match_flg, 'line_id' => $user->line_id];
